...
public class Helper {
    ...
    public static final File MOD1_SRC_MAIN_RESOURCES_DIR = new File(MOD1_BASE_DIR, "src" + File.separator + "main" + File.separator + "resources");
    ...
    public static final File APP1_SRC_MAIN_WEBAPP_DIR = new File(APP1_BASE_DIR, "src" + File.separator + "main" + File.separator + "webapp");
    public static final File APP1_TARGET_DIR = new File(APP1_BASE_DIR, "target" + File.separator + "app1");
    public static final File EDITOR_TARGET_DIR = new File(APP1_BASE_DIR, "target" + File.separator + "editor");
    public static final File EDITOR_POM_XML = new File(EDITOR_TARGET_DIR, "META-INF" + File.separator + "maven" + File.separator + "org.pustefixframework.editor" + File.separator + "pustefix-editor-webui" + File.separator + "pom.xml");
    ...
    public static void createWorkspaceLive() throws Exception {
        String data = "<live>";
        data += "<jar><id><group>a.b.c</group><artifact>mod1</artifact><version>0.1</version></id><directory>" + File.separator + "tmp" + File.separator + "mod1" + File.separator + "src" + File.separator + "main" + File.separator + "resources</directory></jar>";
        data += "<jar><id><group>org.pustefixframework.samples.modules</group><artifact>sample-module-A</artifact><version>0.14.4-SNAPSHOT</version></id><directory>" + File.separator + "tmp" + File.separator + "sample" + File.separator + "src" + File.separator + "main" + File.separator + "resources</directory></jar>";
        data += "<war><id><group>a.b.c</group><artifact>app1</artifact><version>0.3</version></id><directory>" + File.separator + "tmp" + File.separator + "app1" + File.separator + "src" + File.separator + "main" + File.separator + "webapp</directory></war>";
        data += "</live>";
    ...
    public static void createProjectLayout() throws Exception {
        ...
        FileUtils.writeStringToFile(new File(APP1_TARGET_DIR, "core" + File.separator + "file.xml"), "dummy", "UTF-8");
        ...
        FileUtils.writeStringToFile(new File(APP1_SRC_MAIN_WEBAPP_DIR, "core" + File.separator + "file.xml"), "dummy", "UTF-8");
