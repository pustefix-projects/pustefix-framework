    ...
    public synchronized SPDocument handleRequest(PfixServletRequest preq) throws Exception {
        ...
        try {
            ...
            if (!spdoc.getNostore() && (preq.getPageName() == null || !preq.getPageName().equals(spdoc.getPagename()))) {
                ...
                String redirectURL=preq.getScheme() + "://" + ServletManager.getServerName(preq.getRequest()) 
                ...
                spdoc.setSSLRedirect(redirectURL);
            ...
            if(currentpagerequest!=null) {
                PageRequestConfig conf=getConfigForCurrentPageRequest();
                if(conf==null || conf.isStoreXML()) {
