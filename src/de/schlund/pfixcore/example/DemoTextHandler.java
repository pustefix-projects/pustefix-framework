...
import de.schlund.pfixcore.example.iwrapper.DemoText;
...
/**
 * A class handling the request sent by the action of the form.
 * This class is similiar to a Struts Action (inherited from 
 * org.apache.struts.action.Action). 
 * The Struts method perform is similiar to handleSubmittedData.
...
public class DemoTextHandler implements IHandler {
	...
	public void handleSubmittedData(Context context, IWrapper wrapper)
		...
		ContextDemoText cdemotxt   = (ContextDemoText) crm.getResource("de.schlund.pfixcore.example.ContextDemoText");
	    DemoText txtwrp 		   = (DemoText) wrapper;
	    String txt    			   = txtwrp.getDemoText();

	    cdemotxt.reset();
	    System.out.println(" ====> Demo Text is: " + txt);
	    cdemotxt.setDemoText(txt);
	}
	/* (non-Javadoc)
	 * @see de.schlund.pfixcore.generator.IHandler#retrieveCurrentStatus(de.schlund.pfixcore.workflow.Context, de.schlund.pfixcore.generator.IWrapper)
	 */
