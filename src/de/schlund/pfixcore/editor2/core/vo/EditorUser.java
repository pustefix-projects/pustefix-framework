...
public class EditorUser implements Cloneable, Comparable {
     ...
     */
    public EditorProjectPermissions getProjectPermissions(Project project) {
        synchronized (this.projectsPermissions) {
            EditorProjectPermissions permissions = (EditorProjectPermissions) this.projectsPermissions
                    .get(project);
            if (permissions == null) {
     ...
     *            Permissions to set
     */
    public void setProjectPermissions(Project project,
            EditorProjectPermissions projectPermissions) {
        if (project == null || projectPermissions == null) {
            throw new NullPointerException("Parameter may not be null!");
        }
        synchronized (this.projectsPermissions) {
            this.projectsPermissions.put(project, projectPermissions);
        }
    }
