...
public class PageflowStepActionRule extends CheckedRule {
    ...
    public void begin(String namespace, String name, Attributes attributes) throws Exception {
       ...
       // to the action config 
        ...
        PageFlowStepActionConditionConfig condConfig = (PageFlowStepActionConditionConfig) this.getDigester().peek();
        ...
        PageFlowStepActionConfig actionConfig = new PageFlowStepActionConfig();
