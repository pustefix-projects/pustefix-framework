...
@ContextConfiguration(loader=PustefixWebApplicationContextLoader.class,locations={"file:target/pustefix-sample1-0.14.0-SNAPSHOT/WEB-INF/pfixroot/conf/project.xml","file:target/pustefix-sample1-0.14.0-SNAPSHOT/WEB-INF/pfixroot/conf/spring.xml"})
