...
function pfx_editor_Part(pFile, pPart, pTheme, isSelected) {
  ...
  var url = pfx_editor_contextpath + "/" + pfx_editor_pagename 
    + pfx_editor_sessid 
...
pfx_editor_XMLHttpRequest.prototype._sendRequest = function(action, params) {
  this._req.open("GET", pfx_editor_contextpath + "/ws_" + pfx_editor_pagename + ";" + pfx_editor_sessid + "?action=" + action + "&" + params, true);
  this._req.send("");
