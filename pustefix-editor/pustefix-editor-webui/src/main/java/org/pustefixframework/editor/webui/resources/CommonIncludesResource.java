...
public abstract class CommonIncludesResource {
    ...
    public void insertStatus(ResultDocument resdoc, Element elem) throws Exception {
        ...
        if (this.selectedIncludePart != null) {
            ...
            // Render backups
            Collection<String> backups = this.selectedIncludePart.getBackupVersions();
            if (!backups.isEmpty()) {
    ...
    public int restoreBackup(String version, String hash) {
        ...
        try {
            if (this.selectedIncludePart.restore(version)) {
                return 0;
            } else {
                return 1;
            }
    ...
    public String getContent() {
        ...
        if (xml instanceof Element) {
            Map<String, String> xmlnsMappings = projectsResource.getSelectedProject().getPrefixToNamespaceMappings();
     ...
     * (non-Javadoc)
     * 
     * @see org.pustefixframework.editor.webui.resources.CommonIncludesResource#closeDirectoryTree(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.pustefixframework.editor.webui.resources.CommonIncludesResource#closeFileTree(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.pustefixframework.editor.webui.resources.CommonIncludesResource#openDirectoryTree(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.pustefixframework.editor.webui.resources.CommonIncludesResource#openFileTree(java.lang.String)
     */
