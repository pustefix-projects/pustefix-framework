...
public abstract class TargetImpl implements TargetRW, Comparable<Target> {
    ...
    // Target interface
   /**
    * @see org.pustefixframework.xmlgenerator.targets.Target#getType()
    */
    ...
    /**
     * @see org.pustefixframework.xmlgenerator.targets.Target#getTargetKey()
     */
    ...
    /**
     * @see org.pustefixframework.xmlgenerator.targets.Target#getTargetGenerator()
     */
    ...
    /**
     * @see org.pustefixframework.xmlgenerator.targets.Target#getXMLSource()
     */
    ...
    /**
     * @see org.pustefixframework.xmlgenerator.targets.Target#getXSLSource()
     */
    ...
    /**
     * @see org.pustefixframework.xmlgenerator.targets.Target#getParams()
     */
    ...
    /**
     * @see org.pustefixframework.xmlgenerator.targets.Target#getValue()
     */
    ...
    /**
     * @see org.pustefixframework.xmlgenerator.targets.TargetRW#getCurrValue()
     */
    ...
    private void doCacheStatistic(Object value) {
        if (value == null) {
        	getTargetGenerator().getCacheStatistic().registerCacheMiss(this);
        } else {
            getTargetGenerator().getCacheStatistic().registerCacheHit(this);
        }
    }
