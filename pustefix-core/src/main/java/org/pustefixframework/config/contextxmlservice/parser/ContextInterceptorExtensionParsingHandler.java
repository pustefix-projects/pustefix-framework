...
import org.pustefixframework.config.contextxmlservice.parser.internal.ContextInterceptorExtensionImpl;
...
/**
 * Creates an extension for a context interceptor extension point.  
 * 
 * @author Sebastian Marsching <sebastian.marsching@1und1.de>
 */
public class ContextInterceptorExtensionParsingHandler extends AbstractExtensionParsingHandler {
    ...
    protected BeanDefinition createExtension(String type, Collection<ExtensionTargetInfo> extensionTargetInfos, HandlerContext context) throws ParserException {
        ...
        for (Object o : context.getObjectTreeElement().getObjectsOfTypeFromSubTree(Object.class)) {
            if (o instanceof ContextInterceptorHolder) {
        ...
        BeanDefinitionBuilder beanBuilder = BeanDefinitionBuilder.genericBeanDefinition(ContextInterceptorExtensionImpl.class);
