...
import org.pustefixframework.config.contextxmlservice.parser.internal.ScriptedFlowExtensionImpl;
...
/**
 * Creates an extension for a scripted flow extension point.  
 * 
 * @author Sebastian Marsching <sebastian.marsching@1und1.de>
 */
public class ScriptedFlowExtensionParsingHandler extends AbstractExtensionParsingHandler {
    ...
    protected BeanDefinition createExtension(String type, Collection<ExtensionTargetInfo> extensionTargetInfos, HandlerContext context) throws ParserException {
        ...
        List<Object> scriptedFlowObjects = new ManagedList();
        for (Object o : context.getObjectTreeElement().getObjectsOfTypeFromSubTree(Object.class)) {
            if (o instanceof ScriptedFlowProvider) {
                scriptedFlowObjects.add(o);
            } else if (o instanceof PageFlowExtensionPointImpl) {
                scriptedFlowObjects.add(o);
            }
        }

        BeanDefinitionBuilder beanBuilder = BeanDefinitionBuilder.genericBeanDefinition(ScriptedFlowExtensionImpl.class);
        beanBuilder.addPropertyValue("scriptedFlowObjects", scriptedFlowObjects);
