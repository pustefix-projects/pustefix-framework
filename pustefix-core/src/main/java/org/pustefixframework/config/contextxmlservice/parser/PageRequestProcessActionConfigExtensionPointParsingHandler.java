...
/**
 * Handles the declaration of a process action config extension point.
 */
public class PageRequestProcessActionConfigExtensionPointParsingHandler extends AbstractExtensionPointParsingHandler {
    ...
    protected ExtensionPoint<?> createExtensionPoint(String id, String type, String version, String cardinality, HandlerContext context) throws ParserException {
        PageRequestProcessActionConfigExtensionPointImpl extensionPoint = new PageRequestProcessActionConfigExtensionPointImpl();
    ...
    protected Class<?>[] getExportedInterfaces(String id, String type, String version, String cardinality, HandlerContext context) throws ParserException {
        return new Class<?>[] { PageRequestProcessActionConfigExtensionPoint.class };
    }
