...
/**
 * Handles the declaration of a page output resource extension point.
 */
public class PageRequestOutputResourceExtensionPointParsingHandler extends AbstractExtensionPointParsingHandler {
    ...
    protected ExtensionPoint<?> createExtensionPoint(String id, String type, String version, String cardinality, HandlerContext context) throws ParserException {
        PageRequestOutputResourceExtensionPointImpl extensionPoint = new PageRequestOutputResourceExtensionPointImpl();
    ...
    protected Class<?>[] getExportedInterfaces(String id, String type, String version, String cardinality, HandlerContext context) throws ParserException {
        return new Class<?>[] { PageRequestOutputResourceExtensionPoint.class };
    }
