...
/**
 * Handles the declaration of a context interceptor extension point.
 */
public class ContextInterceptorExtensionPointParsingHandler extends AbstractExtensionPointParsingHandler {
    ...
    protected ExtensionPoint<?> createExtensionPoint(String id, String type, String version, String cardinality, HandlerContext context) throws ParserException {
        ContextInterceptorExtensionPointImpl extensionPoint = new ContextInterceptorExtensionPointImpl();
    ...
    protected Class<?>[] getExportedInterfaces(String id, String type, String version, String cardinality, HandlerContext context) throws ParserException {
        return new Class<?>[] { ContextInterceptorExtensionPoint.class };
    }
