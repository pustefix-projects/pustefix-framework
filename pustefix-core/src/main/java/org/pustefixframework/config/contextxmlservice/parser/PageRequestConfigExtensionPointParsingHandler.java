...
/**
 * Handles the declaration of a page config extension point.
 */
public class PageRequestConfigExtensionPointParsingHandler extends AbstractExtensionPointParsingHandler {
    ...
    protected ExtensionPoint<?> createExtensionPoint(String id, String type, String version, String cardinality, HandlerContext context) throws ParserException {
        PageRequestConfigExtensionPointImpl extensionPoint = new PageRequestConfigExtensionPointImpl();
    ...
    protected Class<?>[] getExportedInterfaces(String id, String type, String version, String cardinality, HandlerContext context) throws ParserException {
        return new Class<?>[] { PageRequestConfigExtensionPoint.class };
    }
