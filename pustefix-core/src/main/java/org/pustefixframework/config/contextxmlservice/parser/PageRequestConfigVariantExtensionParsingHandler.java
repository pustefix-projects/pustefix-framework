...
import org.pustefixframework.config.contextxmlservice.parser.internal.PageRequestConfigVariantExtensionImpl;
...
/**
 * Creates an extension for a page configuration variant extension point.  
 * 
 * @author Sebastian Marsching <sebastian.marsching@1und1.de>
 */
public class PageRequestConfigVariantExtensionParsingHandler extends AbstractExtensionParsingHandler {
    ...
    protected BeanDefinition createExtension(String type, Collection<ExtensionTargetInfo> extensionTargetInfos, HandlerContext context) throws ParserException {
        ...
        BeanDefinitionBuilder beanBuilder = BeanDefinitionBuilder.genericBeanDefinition(PageRequestConfigVariantExtensionImpl.class);
