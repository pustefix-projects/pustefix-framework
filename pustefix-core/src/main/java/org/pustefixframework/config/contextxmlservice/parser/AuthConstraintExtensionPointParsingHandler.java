...
/**
 * Handles the declaration of an authconstraint extension point.
 */
public class AuthConstraintExtensionPointParsingHandler extends AbstractExtensionPointParsingHandler {
    ...
    protected ExtensionPoint<?> createExtensionPoint(String id, String type, String version, String cardinality, HandlerContext context) throws ParserException {
        AuthConstraintExtensionPointImpl extensionPoint = new AuthConstraintExtensionPointImpl();
    ...
    protected Class<?>[] getExportedInterfaces(String id, String type, String version, String cardinality, HandlerContext context) throws ParserException {
        return new Class<?>[] { AuthConstraintExtensionPoint.class };
    }
