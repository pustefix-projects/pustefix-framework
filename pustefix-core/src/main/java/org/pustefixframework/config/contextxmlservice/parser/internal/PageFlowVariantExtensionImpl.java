...
/**
 * Extension for page flow variant extension point.  
 * 
 * @author Sebastian Marsching <sebastian.marsching@1und1.de>
 */
public class PageFlowVariantExtensionImpl extends AbstractExtension<PageFlowVariantExtensionPoint, PageFlowVariantExtensionImpl> implements PageFlowVariantExtension {

    private InternalPageFlowMap pageFlowMap = new InternalPageFlowMap();

    public PageFlowVariantExtensionImpl() {
        setExtensionPointType(PageFlowVariantExtensionPoint.class);
    }
    ...
    private class InternalPageFlowMap extends PageFlowMap  {
        ...
        protected void updateCache() {
            ...
            synchronized (registrationLock) {
                for (PageFlowVariantExtensionPoint extensionPoint : extensionPoints) {
                    extensionPoint.updateExtension(PageFlowVariantExtensionImpl.this);
                }
            }
        }
