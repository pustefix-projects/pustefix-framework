...
/**
 * Handles the declaration of a JSON output resource extension point.
 */
public class JSONOutputResourceExtensionPointParsingHandler extends AbstractExtensionPointParsingHandler {
    ...
    protected ExtensionPoint<?> createExtensionPoint(String id, String type, String version, String cardinality, HandlerContext context) throws ParserException {
        JSONOutputResourceExtensionPointImpl extensionPoint = new JSONOutputResourceExtensionPointImpl();
    ...
    protected Class<?>[] getExportedInterfaces(String id, String type, String version, String cardinality, HandlerContext context) throws ParserException {
        return new Class<?>[] { JSONOutputResourceExtensionPoint.class };
    }
