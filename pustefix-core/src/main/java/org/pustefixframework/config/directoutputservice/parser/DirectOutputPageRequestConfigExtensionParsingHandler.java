...
import org.pustefixframework.config.directoutputservice.parser.internal.DirectOutputPageRequestConfigExtensionImpl;
...
/**
 * Creates an extension for a direct output page configuration extension point.  
 * 
 * @author Sebastian Marsching <sebastian.marsching@1und1.de>
 */
public class DirectOutputPageRequestConfigExtensionParsingHandler extends AbstractExtensionParsingHandler {
    ...
    protected BeanDefinition createExtension(String type, Collection<ExtensionTargetInfo> extensionTargetInfos, HandlerContext context) throws ParserException {
        ...
        for (Object o : context.getObjectTreeElement().getObjectsOfTypeFromSubTree(Object.class)) {
            if (o instanceof DirectOutputPageRequestConfigHolder) {
                DirectOutputPageRequestConfigHolder pageConfigHolder = (DirectOutputPageRequestConfigHolder) o;
                pageConfigObjects.add(pageConfigHolder.getDirectOutputPageRequestConfigObject());
            } else if (o instanceof DirectOutputPageRequestConfigExtensionPointImpl) {
                pageConfigObjects.add(o);
            }
        }

        BeanDefinitionBuilder beanBuilder = BeanDefinitionBuilder.genericBeanDefinition(DirectOutputPageRequestConfigExtensionImpl.class);
        beanBuilder.addPropertyValue("directOutputPageRequestConfigObjects", pageConfigObjects);
