...
/**
 * Handles the declaration of a direct output page config extension point.
 */
public class DirectOutputPageRequestConfigExtensionPointParsingHandler extends AbstractExtensionPointParsingHandler {
    ...
    protected ExtensionPoint<?> createExtensionPoint(String id, String type, String version, String cardinality, HandlerContext context) throws ParserException {
        DirectOutputPageRequestConfigExtensionPointImpl extensionPoint = new DirectOutputPageRequestConfigExtensionPointImpl();
    ...
    protected Class<?>[] getExportedInterfaces(String id, String type, String version, String cardinality, HandlerContext context) throws ParserException {
        return new Class<?>[] { DirectOutputPageRequestConfigExtensionPoint.class };
    }
