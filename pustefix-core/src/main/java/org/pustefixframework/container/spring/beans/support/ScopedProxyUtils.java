 ...
 * 
 * This is a modified version of the original class using a different
 * class loader.
 */
...
public abstract class ScopedProxyUtils {
    ...
    public static BeanDefinitionHolder createScopedProxy(BeanDefinitionHolder definition,
        ...
        if (definition.getBeanDefinition() instanceof AbstractBeanDefinition) {
            AbstractBeanDefinition beanDefinition = (AbstractBeanDefinition) definition.getBeanDefinition();
            if (beanDefinition.getBeanClass() != null) {
                beanClassLoader = beanDefinition.getBeanClass().getClassLoader();
            }
        }
        scopedProxyDefinition.getPropertyValues().addPropertyValue("beanClassLoader", beanClassLoader);
