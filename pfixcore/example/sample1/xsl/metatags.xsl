<?xml version="1.0" encoding="ISO-8859-1"?><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:pfx="http://www.schlund.de/pustefix/core" xmlns:cus="http://www.schlund.de/pustefix/customize" xmlns:ixsl="http://www.w3.org/1999/XSL/TransformOutputAlias" version="1.0">
  ...
  <xsl:template match="overviewinfo">
    <table width="500" class="boxed" bgcolor="#ffcccc">
      ...
      <tr valign="top">
        <td>Size: <ixsl:value-of select="/formresult/cr_tshirt/@size"/></td>
        <td>ColorNo: <ixsl:value-of select="/formresult/cr_tshirt/@color"/></td>
        <td>
          <ixsl:for-each select="/formresult/cr_tshirt/feature">
            <ixsl:value-of select="./text()"/><br/>
          </ixsl:for-each>
        </td>
      </tr>
    </table>
    <ixsl:if test="/formresult/cr_adultinfo[@adult = 'true']">
      <br/>
      <table width="500" class="boxed" bgcolor="#ccccff">
        ...
        <tr valign="top">
          <td>Size: <ixsl:value-of select="/formresult/cr_trouser/@size"/></td>
          <td>ColorNo: <ixsl:value-of select="/formresult/cr_trouser/@color"/></td>
          <td>
            <ixsl:for-each select="/formresult/cr_trouser/feature">
              <ixsl:value-of select="./text()"/><br/>
            </ixsl:for-each>
          </td>
        </tr>
