...
public class SearchResult
{
  ...
  public SearchResult(PfixTextArea textArea, Position start, Position end)
  {
    this.start = start;
    this.end = end;
  ...
  private String getLine(Element elem)
  {
    ...
    text = text.substring(de.schlund.pfixeditor.misc.Utilities.getLeadingWhiteSpace(text));
    if (text.length() > 70)
