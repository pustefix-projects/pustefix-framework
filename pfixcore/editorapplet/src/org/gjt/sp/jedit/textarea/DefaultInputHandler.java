  ...
  public void keyPressed(KeyEvent evt)
  {
    ...
    if (evt.isShiftDown())
    {
      ...
      if (o == null)
      {
        ...
        ((PfixTextArea) getTextArea(evt)).endCurrentEdit();
  ...
  public void keyTyped(KeyEvent evt)
  {
    ...
    if (c != KeyEvent.CHAR_UNDEFINED && !evt.isAltDown())
    {
      if (c >= 0x20 && c != 0x7f)
      {
       ...
       /* 
        else if (o instanceof de.schlund.pfixeditor.view.OneClickAction) {
          currentBindings = bindings;
          ((PfixTextArea) getTextArea(evt)).endCurrentEdit();
          executeOneClickAction((de.schlund.pfixeditor.view.OneClickAction) o, evt.getSource(), String.valueOf(c));
          return;
        }
        */
        else if (o instanceof ActionListener) {
        ...
        ((PfixTextArea) getTextArea(evt)).userInput(c);
