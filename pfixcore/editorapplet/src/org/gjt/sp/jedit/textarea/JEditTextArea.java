 ...
 * Portion Copyrights (C) 2001 Romain Guy
 *
...
import de.schlund.pfixeditor.view.OneClickAction;
 ...
 * @version $Id$
 * 
 * This version is modified to get the TextArea run in a applet.
 * Main changes: -focusedComponent is set when we get the focus (in FocusHandler)
 *               -Workaround to ensure, that the textarea really gets the focus
 *               -some static methods removed:
 *                We don't know, when the browser releases the applet.
 *                Therefore we face some problems when reloading the applet
 *                
 * author: Rouven Schoeller
 *               
 */
public class JEditTextArea extends JComponent
{
  ...
  private Gui view;
  private static String clpBoard=null;
  ...
  /**
    ...
    */
  public JEditTextArea(Gui view, TextAreaDefaults defaults)
  {
    this.view = view;
     // --da rouven -------
    ...
    add(LEFT, gutter);
    add(CENTER, painter);
    JScrollBar scrBarVert=new JScrollBar(JScrollBar.VERTICAL);
    scrBarVert.addMouseListener(new BlinkMouseHandler());
    JScrollBar scrBarHorz=new JScrollBar(JScrollBar.HORIZONTAL);
    scrBarHorz.addMouseListener(new BlinkMouseHandler());
    add(RIGHT, vertical = scrBarVert);
    add(BOTTOM, horizontal = scrBarHorz);
    ...
    // only if we get the focus (event triggers focuslistener), 
    // we should be the focusedcomponent 
  ...
  protected void finalize() throws Throwable
  {
    ...
    caretEvent = null;
    lineSegment = null;
    Log.println("JEditTextArea: finalize");
  }
  ...
  {
    //Log.println("blinkCaret: ");
    if (caretBlinks)
    {
      //Log.println(" yes "+blink+"->"+!blink);  
      blink = !blink;
      painter.invalidateSelectedLines();
    } else {
      blink = true;
...
//      { 
  ...
  Log.println("JEditTextArea: processKeyEvent: id="+evt.getID()+" char="+evt.getKeyChar()+" code="+evt.getKeyCode()+" text="+evt.getKeyText(evt.getKeyCode()));
    ...
    if (inputHandler==null) {
        Log.println("jeditTextArea: inputhandler=null !!");
    }
  ...
  protected /*static*/ JEditTextArea focusedComponent=null;
  ...
  /*static*/ class CaretBlinker implements ActionListener
  {
    ...
    {
      //Log.println("CaretBlinker: actionPerformed: ");
      
      Component focusOwner =
        KeyboardFocusManager.getCurrentKeyboardFocusManager().
            getFocusOwner();
       if (focusOwner != null) {
        //Log.println("focusOwner: "+focusOwner.toString());
       }
  ...
  class FocusHandler implements FocusListener
  {
    public void focusGained(FocusEvent evt)
    {
      ...
      Log.println("JEditTextArea: FocusListener: GAINED");
      JEditTextArea.this.view.disposeDummyScreen();
    }
    ...
    public void focusLost(FocusEvent evt)
    {
      ...
      focusedComponent = null;
      Log.println("JEditTextArea: FocusListener: LOST");
  ...
  public void setOneClick(de.schlund.pfixeditor.view.OneClickAction oneClick)
  {
    setOneClick(oneClick, null);
  }

  public void setOneClick(de.schlund.pfixeditor.view.OneClickAction oneClick, ActionEvent oneClickEvent)
  {
/*    this.oneClick = oneClick;
    this.oneClickEvent = oneClickEvent;

    PfixTextArea area = (PfixTextArea) this;
    area.getJextParent().setStatus(area);
*/
  }

  protected ActionEvent oneClickEvent;
  public de.schlund.pfixeditor.view.OneClickAction oneClick;
  ...
  class BlinkMouseHandler extends MouseAdapter
  {
     /**
     * Invoked when the mouse enters a component.
     */
    public void mouseEntered(MouseEvent e) {
        Log.println("BlinkMouseHandler:moueseEntered");
    ...
    public void mouseExited(MouseEvent e) {
        ...
        Log.println("BlinkMouseHandler:moueseExited");
    }
  }
  ...
  class MouseHandler extends MouseAdapter
  {
     ...
     */
    public void mouseEntered(MouseEvent e) {
        Log.println("JeditTextArea:moueseEntered");
        setCaretBlinkEnabled(true);
       
        
        JEditTextArea.this.requestFocus();
        JEditTextArea.this.requestFocusInWindow();
    ...
    public void mouseExited(MouseEvent e) {
        setCaretBlinkEnabled(false);
        Log.println("JeditTextArea:moueseExited");
    }
    ...
    public void mousePressed(MouseEvent evt)
    {
      ...
      JEditTextArea.this.requestFocus();
      JEditTextArea.this.requestFocusInWindow();
      // Sometimes we don't get the focus in a browsers applet view. 
      // Reason is that the applet frame don't receive the window focus
      // So this is a workaround 
      
      if(focusedComponent==null) {
        Log.println("textarea is not focused");
        view.createDummyScreen();
        //WaFrame=new SplashScreen();
      ...
      setCaretVisible(true);
      //only if we get the focus (event triggers focuslistener), we should be the focusedcomponent 
      //focusedComponent = JEditTextArea.this;
    ...
    private void doSingleClick(MouseEvent evt, int line, int offset, int dot)
    {
     ...
     //((PfixTextArea) PfixTextArea.this).endCurrentEdit();
    ...
    private void doRightClick(MouseEvent evt)
    {
      ...
      Gui view = ((PfixTextArea) JEditTextArea.this).getPfixParent();
...
/*
  ...
  * Initial revision
  *
  * Revision 1.2  2002/10/18 12:38:08  rouven
  * *** empty log message ***
  *
