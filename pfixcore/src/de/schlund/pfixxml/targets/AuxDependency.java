...
public class AuxDependency implements Comparable {
    ...
    public Set getAffectedTargetGenerators() {
        synchronized (affectedtargets) { // Note: this is right, we only change aff.tgen when in
                                         // synchronized blocks of affectedtargets.
