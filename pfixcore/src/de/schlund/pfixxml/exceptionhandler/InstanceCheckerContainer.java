...
class InstanceCheckerContainer {
     ...
     * @param type the type of the exception against incoming exceptions will be checked. 
     * @param match determines if incoming exception should be checked only against the
     * <see>type</see> or also against their stacktrace. If stacktraces should be checked
     * the containing <see>StraceCheckerContainer</see> will be asked if they match the
     * incoming exception. 
     * @param limit a number which specifies the maximum average of matches the allow per 
     * time rate <see>limit_dim</see>.
    ...
    /**
     * Return the number of not matched exceptions of this instancecheckercontainer and reset it.
    ...
    /**
    * Retrieve report data. This is called from the <see>ReportGeneratorTask</see>-Thread so it must
    ...
    */
    ...
    /**
     * Checks if the incoming exception will met the prerequisites. If for <see>match</see> 
     * attribute the exception type is given it looks if the incoming exception is an
     * instance of the stored exception type specified by the <see>type</see> parameter.  
     * If for the <see>match</see> attribute the stacktrace is given, the containing
     * <see>STraceCheckerContainer</see>will be asked if they match ( the exception type
