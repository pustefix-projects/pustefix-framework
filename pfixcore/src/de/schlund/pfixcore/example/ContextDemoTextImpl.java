...
/**
 * A class representing our ContextResource. 
 * It has been createdto store the text sent by the form in order to
 * give it out on the second page.
 * 
...
public class ContextDemoTextImpl implements ContextDemoText {
	 ...
	 */
	public void insertStatus(ResultDocument resdoc, final Element root) throws Exception {
		if (demoText != null) {
			resdoc.createSubNode(root, "demotext").setAttribute("value", demoText);	
		}
	}
