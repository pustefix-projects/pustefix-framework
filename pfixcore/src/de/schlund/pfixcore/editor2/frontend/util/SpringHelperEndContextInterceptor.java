...
/**
 * This interceptor is used to remove the context from the Spring bean after the
 * processing has been done.
 * 
 * @author Sebastian Marsching <sebastian.marsching@1und1.de>
 * @see de.schlund.pfixcore.editor2.frontend.util.SpringHelperStartContextInterceptor
 */
public class SpringHelperEndContextInterceptor implements ContextInterceptor {
    ...
    public void process(Context context, PfixServletRequest preq) {
        ...
        service.setPustefixContext(null);
    }
