...
public class PageImpl extends AbstractPage implements MutablePage {
     ...
     * 
     * @param targetfactory Reference to the TargetFactoryService
     * @param pageName Name of the page to create (without variant)
     * @param variant Variant of the page (or <code>null</code> for default)
     * @param handler String describing the handler being used to serve this page
     * @param themes List of the themes being used by this page
     * @param parent Parent of this page in navigation (or <code>null</code> if this is a top-level page)
     * @param childs Childs of this page in navigation
     * @param project Project this page belongs to
     * @param tgen TargetGenerator used for this page's target
     * @param pinfo Used to identify this page within the Pustefix generator
     */
    public PageImpl(TargetFactoryService targetfactory, String pageName, Variant variant, String handler, ThemeList themes, Page parent, Project project, PageInfo pinfo) {
    ...
    public Target getPageTarget() {
        return this.targetfactory.getTargetFromPustefixTarget(this.pinfo.getTargetGenerator().getPageTargetTree().getTargetForPageInfo(this.pinfo), this.getProject());
    }
     ...
     * 
     * @param page Collection containing Page objects to add as sub-page
     */
