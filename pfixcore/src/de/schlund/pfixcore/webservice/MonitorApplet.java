...
public class MonitorApplet extends JApplet {
    ...
    public void init() {
        ...
        pages = new Vector();
        addPage(new MonitorPage(getCodeBase().getHost()));
    }

    /**
     * Add a page to the notebook
     */
    private void addPage(MonitorPage pg) {
    ...
    public void start() {
        ...
        while (e.hasMoreElements()) {
            MonitorPage pg = (MonitorPage) e.nextElement();
            if (pg != null) {
                pg.start();
            }
        }
     ...
     */
    class MonitorPage extends JPanel 
                          implements Runnable,
        ...
        private MonitorTableModel model = null;
        ...
        private MonitorTextArea   request_text = null;
        private MonitorTextArea   response_text = null;
        ...
        private MonitorFilter     filter = null;
         ...
         */
        public MonitorPage(String host_name) {
            host = host_name;
            ...
            request_text = new MonitorTextArea();
            ...
            response_text = new MonitorTextArea();
                ...
                try {
                    ...
                    switch (message_type.intValue()) {
                        case MonitorConstants.MONITOR_REQUEST:
                            ...
                            break;
                        case MonitorConstants.MONITOR_RESPONSE:
        ...
        public void valueChanged(ListSelectionEvent e) {
            ...
            if (row == -1) {
                ...
                MonitorData soap = model.getData(row);
    ...
    class MonitorData {
         ...
         * Constructor
         */
        public MonitorData(Long id, String target, String soap_request) {
            this.id = id;
    ...
    class MonitorTableModel extends AbstractTableModel {
        ...
        public MonitorTableModel() {
            ...
            MonitorData soap = new MonitorData(null,null,null);
        ...
        public Object getValueAt(int row, int col) {
            MonitorData soap;
            String          value = null;
            soap = (MonitorData) data.elementAt(row);
            if (filter_data != null) {
                soap = (MonitorData) filter_data.elementAt(row);
            }
            switch (col) {
                case 0:
                    value = soap.getTime();
         ...
         */
        public boolean filterMatch(MonitorData soap) {
            boolean match = true;
         ...
         */
        public void addData(MonitorData soap) {
            int row = data.size();
            data.addElement(soap);
            if (filter_data != null) {
                if (filterMatch(soap)) {
         ...
         */
        public MonitorData findData(Long id) {
            MonitorData soap = null;
            for (int row=data.size(); (row > 0) && (soap == null); row--) {
                soap = (MonitorData) data.elementAt(row-1);
         ...
         */
        public int findRow(MonitorData soap) {
            int row = -1;
            if (filter_data != null) {
        ...
        public void applyFilter() {
            ...
            if ((filter_include != null) || 
                ...
                MonitorData soap;
                while (e.hasMoreElements()) {
                    soap = (MonitorData) e.nextElement();
                    if (filterMatch(soap)) {
                        filter_data.addElement(soap);
                    }
                }
         ...
         */
        public MonitorData getData(int row) {
            MonitorData soap = null;
            if (filter_data == null) {
                soap = (MonitorData) data.elementAt(row);
            } else {
         ...
         * Update a message
         */
        public void updateData (MonitorData soap) {
           int row;
           if (filter_data == null) {
     ...
     */
    class MonitorFilter implements ActionListener {
     ...
     */
    class MonitorTextArea extends JTextArea {
