 ...
 * @web.servlet name="MonitorService"  display-name="MonitorService"  load-on-startup="100"
 * @web.servlet-mapping url-pattern="/Monitor"
 * @web.servlet-init-param name="MonitorPort" value="5001"
 */
...
public class MonitorService extends HttpServlet {
  ...
  public void init() throws ServletException {
    ...
    if (server_socket == null) {
      ...
      String port = config.getInitParameter(MonitorConstants.MONITOR_PORT);
      if (port == null) {
              ...
              throws IOException, ServletException
  {
   ...
   response.getWriter().println("<param name=code value=MonitorApplet.class>");
   ...
   response.getWriter().println("<embed type=\"application/x-java-applet;version=1.3\" code=MonitorApplet.class width=100% height=100% port=\""+port+"\" scriptable=false pluginspage=\"http://java.sun.com/products/plugin/1.3/plugin-install.html\">"); 
