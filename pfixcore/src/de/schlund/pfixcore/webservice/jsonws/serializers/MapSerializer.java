        ...
        if(obj instanceof Map) {
            ...
            while(it.hasNext()) {
                ...
                if(key instanceof String) { 
                    ...
                    if(val==null) {
                        jsonObj.putMember(key.toString(),JSONObject.NULL);
                    } else {
                        Object serObj=ctx.serialize(val);
                        jsonObj.putMember(key.toString(),serObj);
                    }
                } else throw new SerializationException("Unsupported Map key type (must be java.lang.String): "+key.getClass().getName());
            } 
        }
        return jsonObj;
    }
