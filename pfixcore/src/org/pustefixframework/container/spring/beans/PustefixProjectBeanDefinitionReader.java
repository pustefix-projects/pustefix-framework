...
public class PustefixProjectBeanDefinitionReader extends AbstractBeanDefinitionReader {
    ...
    public int loadBeanDefinitions(Resource resource) throws BeanDefinitionStoreException {
        ...
        try {
            Parser projectConfigParser = new ClasspathConfiguredParser("org/pustefixframework/config/project/parser/project-config.xml");
            projectConfigTree = projectConfigParser.parse(resource.getInputStream(), info);
