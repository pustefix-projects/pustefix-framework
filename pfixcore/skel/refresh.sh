...
#####################################################################
# WebappAdminClient script for Spring-ApplicationContext refreshing #
#####################################################################
...
java -cp build:$PFX_LIBS org.pustefixframework.admin.WebappAdminClient -p $PFX_PID -c refresh $*
