...
public abstract class MenuAction implements ActionListener
{
  ...
  public static PfixTextArea getTextArea(EventObject evt)
  {
  ...
  public static PfixTextArea getNSTextArea(EventObject evt)
  {
  ...
  public static Gui getJextParent(EventObject evt)
  {
    if (evt != null)
    {
 ...
 /*
            ...
            return (Gui) ((JComponent) c).getClientProperty("JEXT_INSTANCE");
 */
          else
  ...
  public static PfixTextArea getTextArea(Component c)
  {
    return getJextParent(c).getTextArea();
  }

  public static PfixTextArea getNSTextArea(Component c)
  {
    return getJextParent(c).getNSTextArea();
  }

  public static Gui getJextParent(Component comp)
  {
    for ( ; ; )
    {
