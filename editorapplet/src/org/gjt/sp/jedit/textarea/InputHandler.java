...
public abstract class InputHandler extends KeyAdapter
{
  ...
  {
    Log.println("InputHandler: getAction: name:"+name);
...
*/
  ...
  public void executeAction(ActionListener listener, Object source, String actionCommand)
  {
    ...
    if (listener instanceof de.schlund.pfixeditor.view.EditAction && !getTextArea(evt).isEditable())
      return;
  ...
  public static class backspace_word implements ActionListener
  {
    public void actionPerformed(ActionEvent evt)
    {
      ...
      {
        String noWordSep = ((PfixTextArea) textArea).getProperty("noWordSep");
 ...
 * Initial revision
 *
 * Revision 1.1  2002/10/16 19:04:35  rouven
 * *** empty log message ***
 *
