...
public class Search
{
  ...
  {
    findPattern = Props.getProperty("find");
    replacePattern = Props.getProperty("replace");
    useRegexp = Props.getBooleanProperty("useregexp");
    ignoreCase = Props.getBooleanProperty("ignorecase");
    script = Props.getBooleanProperty("replacescript");
    pythonScript = Props.getProperty("pythonscript");
  }

  public static void save()
  {
    Props.setProperty("find", findPattern);
    Props.setProperty("replace", replacePattern);
    Props.setProperty("pythonscript", pythonScript);
    Props.setProperty("ignorecase", ignoreCase ? "on" : "off");
    Props.setProperty("useregexp", useRegexp ? "on" : "off");
    Props.setProperty("replacescript", script ? "on" : "off");
  }
  ...
  public static SearchMatcher getSearchMatcher(boolean reverseOK) throws Exception
  {
    ...
    if (useRegexp)
      ...
      Log.println("BoxerMooreSearchMatcher args:\n pattern="+findPattern+" replace="+replace+" reverse="+(reverseSearch && reverseOK)+" script="+script+" pythonscript="+pythonScript);  
  ...
  public static boolean find(PfixTextArea textArea, final int start) throws Exception
  {
  ...
  public static boolean replace(PfixTextArea textArea)
  {
  ...
  public static int replaceAll(PfixTextArea textArea, int start, int end) throws Exception
  {
    if (!textArea.isEditable())
      return 0;
