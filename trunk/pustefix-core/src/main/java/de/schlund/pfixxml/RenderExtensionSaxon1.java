...
public class RenderExtensionSaxon1 {
    ...
    public static boolean render(Context saxonContext, TargetGenerator targetGenerator, String href, 
    ...
    public static void renderStart(Context saxonContext, RenderContextSaxon1 renderContext) throws Exception {     
        try {
        	if(renderContext.getContextNode() != null) {
        		saxonContext.setContextNode((NodeInfo)renderContext.getContextNode());
        	}
