...
public class DynIncludeFileImpl extends CommonIncludeFileImpl {
    ...
    public DynIncludeFileImpl(RemoteServiceUtil remoteServiceUtil, String path) {
        super(remoteServiceUtil, path);
    }
    ...
    @Override
    protected IncludePart newIncludePartInstance(String name) {
        return new DynIncludePartImpl(remoteServiceUtil, path, name);
    }
