...
public interface RemoteImageService {
    ImageTO getImage(String path);
    void replaceFile(String path, byte[] newContent) throws EditorIOException, EditorSecurityException;
    boolean restoreImage(String imagePath, String version) throws EditorSecurityException;
    Collection<String> listImageVersions(String imagePath);
}
