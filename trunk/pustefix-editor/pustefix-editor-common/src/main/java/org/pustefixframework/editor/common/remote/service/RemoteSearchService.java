...
public interface RemoteSearchService {
    SearchResultTO search(String content, String tags, String attributeKey, String attributeValue, String comment) throws EditorSearchIndexException, EditorSearchQueryException;
}
